        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
                ...
                <div class="sidebar-brand-icon rotate-n-15">
                    <div class="sidebar-brand-text mx-3"  href="{{route('dashboard')}}">Blog Site Admin </div>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{asset('back')}}/#" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span class="@if(Request::segment(2)=="blogs") active @endif">Blogs</span>
                </a>
                <div id="collapseTwo" class="collapse @if(Request::segment(2)=="blogs") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item @if(Request::segment(2)=="blogs" && Request::segment(3)=="") active @endif" href="{{route('blogs')}}">All Blogs</a>
                        <a class="collapse-item @if(Request::segment(2)=="blogs" && Request::segment(3)=="create" ) active @endif" href="{{route('create_blog')}}">New Blog</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success btn-sm" href="{{asset('back')}}/https://startbootstrap.com/theme/sb-admin-pro">Upgrade to Pro!</a>
            </div>
